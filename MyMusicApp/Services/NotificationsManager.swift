    ...
    func scheduleNotification(titleText: String, bodyText: String) {
        ...
        UNUserNotificationCenter.current().add(request) { [weak self] error in
            if let error = error {
                ...
                let sentNotification = ReceivedNotification(identifier: request.identifier,
                                                            date: Date(),
                                                            titleText: request.content.title,
                                                            bodyText: request.content.body, artistName: titleText
                                                            )
